...
QDEF(MP_QSTR_multiple_ints, (const byte*)"\x8a\xc3\x0d" "multiple_ints")
...
QDEF(MP_QSTR___sha__, (const byte*)"\x5f\xed\x07" "__sha__")
...
QDEF(MP_QSTR_loadtxt, (const byte*)"\xbb\xc5\x07" "loadtxt")
QDEF(MP_QSTR_roll, (const byte*)"\x58\x02\x04" "roll")
QDEF(MP_QSTR_savetxt, (const byte*)"\x5c\x47\x07" "savetxt")
...
QDEF(MP_QSTR_delimiter, (const byte*)"\xc6\x55\x09" "delimiter")
QDEF(MP_QSTR_comments, (const byte*)"\xa5\x69\x08" "comments")
QDEF(MP_QSTR_max_rows, (const byte*)"\xb7\x55\x08" "max_rows")
...
QDEF(MP_QSTR_footer, (const byte*)"\x00\x21\x06" "footer")
