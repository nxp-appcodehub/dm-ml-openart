...
static int set_pixformat(sensor_t *sensor, pixformat_t pixformat)
{
    ...
    switch (pixformat) {
        case PIXFORMAT_RGB565:
            outputFormat |= ((1U << 8U)|MT9M114_OUTPUT_FORMAT_SWAP_BYTES);
...
static int set_framesize(sensor_t *sensor, framesize_t framesize)
{
	...
	cambus_readws(sensor,MT9M114_VAR_CAM_OUTPUT_HEIGHT, &value,2);
	cambus_readws(sensor,MT9M114_VAR_CAM_OUTPUT_WIDTH, &value,2);
    return 0;
}
